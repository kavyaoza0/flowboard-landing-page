    ...
    <section className="py-28" ref={ref}>
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="mt-10 space-y-5">
              {benefits.map((b, i) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground group-hover:text-primary transition-colors duration-300">{b.title}</h4>
          ...
          >
            <TiltCard className="glass-card rounded-2xl p-6 floating-shadow">
