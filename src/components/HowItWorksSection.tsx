        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {steps.map((step, i) => (
            <motion.div
              ...
              transition={{ delay: 0.2 + i * 0.18, duration: 0.6, ease: [0.21, 0.47, 0.32, 0.98] }}
              className="relative"
            >
              <TiltCard className={`text-center rounded-xl p-8 bg-gradient-to-b ${step.gradient} border border-border/30`}>
                <motion.div
                  className="text-6xl font-black text-primary/15 mb-4"
                  whileHover={{ scale: 1.15, color: "hsl(var(--primary) / 0.3)" }}
